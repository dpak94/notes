---
layout: post
title: Clean Code Norms for JavaScript
...
2. Don't comment *how*, comment *why*. The viewer reads the code to find *how*.
...
7. Avoid extremely large function. Break them into samller ones.
